<template>
    ...
    <div>
        <TeamStats
            v-for="meilleur_chauffeur in total_versements_par_controleur"
            :key="meilleur_chauffeur?.telephone"
            :photo="meilleur_chauffeur?.photo"
            :nom="meilleur_chauffeur?.immatriculation"
...
const total_versements_par_controleur = computed(()=>versementsStore.total_versements_par_vehicule)
...
onMounted(async()=> {
    ...
    await versementsStore.fetchTotalVersementParVehicule()
